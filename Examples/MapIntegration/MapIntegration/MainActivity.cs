...
{
    [Activity(Label = "MapIntegration", MainLauncher = true)]
    public class MainActivity : Activity, IOnMapReadyCallback
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            lines.Add(new LatLng(37.777113, -122.394983)); // 2
            lines.Add(new LatLng(37.776831, -122.394627)); // 3
            lines.Add(new LatLng(37.776831, -122.404627)); // 4
